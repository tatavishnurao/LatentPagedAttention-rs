// GENERATED mechanically from the P0 kernels; logic and tile shapes are unchanged.

#[cutile::module]
pub mod full_kv_baseline_kernel_1024 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_scores_fp16_storage_1024(
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_context_fp16_storage_1024(
...
#[cutile::module]
pub mod model_profile_kernel_1024 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_1024(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [64] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_context_fp16_storage_1024(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 1024] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [64] }>,
...
#[cutile::module]
pub mod model_profile_preprojected_kernel_1024 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_project_query_once_1024(
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_preprojected_1024(
        out: &mut Tensor<f32, { [1, 16] }>,
...
#[cutile::module]
pub mod full_kv_baseline_kernel_2048 {
    use cutile::core::*;

    fn physical_block(table: &Tensor<i32, { [128] }>, logical: i32) -> i32 {
        let table_tile: Tile<i32, { [128] }> = table.load_tile(const_shape![128], [0]);
        let selected: Tile<i32, { [1] }> = extract(table_tile, [scalar_to_tile(logical)]);
        tile_to_scalar(selected.reshape(const_shape![]))
    }
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_scores_fp16_storage_2048(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [128] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_context_fp16_storage_2048(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 2048] }>,
        v_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [128] }>,
...
#[cutile::module]
pub mod model_profile_kernel_2048 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_2048(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [128] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_context_fp16_storage_2048(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 2048] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [128] }>,
...
#[cutile::module]
pub mod model_profile_preprojected_kernel_2048 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_project_query_once_2048(
        out: &mut Tensor<f32, { [1, 32] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_projection: &Tensor<f32, { [-1, 64] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_preprojected_2048(
        out: &mut Tensor<f32, { [1, 16] }>,
        projected_query: &Tensor<f32, { [-1, 32] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [128] }>,
...
#[cutile::module]
pub mod full_kv_baseline_kernel_4096 {
    use cutile::core::*;

    fn physical_block(table: &Tensor<i32, { [256] }>, logical: i32) -> i32 {
        let table_tile: Tile<i32, { [256] }> = table.load_tile(const_shape![256], [0]);
        let selected: Tile<i32, { [1] }> = extract(table_tile, [scalar_to_tile(logical)]);
        tile_to_scalar(selected.reshape(const_shape![]))
    }
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_scores_fp16_storage_4096(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [256] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_context_fp16_storage_4096(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 4096] }>,
        v_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [256] }>,
...
#[cutile::module]
pub mod model_profile_kernel_4096 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_4096(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [256] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_context_fp16_storage_4096(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 4096] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [256] }>,
...
#[cutile::module]
pub mod model_profile_preprojected_kernel_4096 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_project_query_once_4096(
        out: &mut Tensor<f32, { [1, 32] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_projection: &Tensor<f32, { [-1, 64] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_preprojected_4096(
        out: &mut Tensor<f32, { [1, 16] }>,
        projected_query: &Tensor<f32, { [-1, 32] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [256] }>,
...
#[cutile::module]
pub mod full_kv_baseline_kernel_8192 {
    use cutile::core::*;

    fn physical_block(table: &Tensor<i32, { [512] }>, logical: i32) -> i32 {
        let table_tile: Tile<i32, { [512] }> = table.load_tile(const_shape![512], [0]);
        let selected: Tile<i32, { [1] }> = extract(table_tile, [scalar_to_tile(logical)]);
        tile_to_scalar(selected.reshape(const_shape![]))
    }
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_scores_fp16_storage_8192(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [512] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_context_fp16_storage_8192(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 8192] }>,
        v_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [512] }>,
...
#[cutile::module]
pub mod model_profile_kernel_8192 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_8192(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [512] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_context_fp16_storage_8192(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 8192] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [512] }>,
...
#[cutile::module]
pub mod model_profile_preprojected_kernel_8192 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_project_query_once_8192(
        out: &mut Tensor<f32, { [1, 32] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_projection: &Tensor<f32, { [-1, 64] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_preprojected_8192(
        out: &mut Tensor<f32, { [1, 16] }>,
        projected_query: &Tensor<f32, { [-1, 32] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [512] }>,
...
#[cutile::module]
pub mod full_kv_baseline_kernel_16384 {
    use cutile::core::*;

    fn physical_block(table: &Tensor<i32, { [1024] }>, logical: i32) -> i32 {
        let table_tile: Tile<i32, { [1024] }> = table.load_tile(const_shape![1024], [0]);
        let selected: Tile<i32, { [1] }> = extract(table_tile, [scalar_to_tile(logical)]);
        tile_to_scalar(selected.reshape(const_shape![]))
    }
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_scores_fp16_storage_16384(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [1024] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_context_fp16_storage_16384(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 16384] }>,
        v_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [1024] }>,
...
#[cutile::module]
pub mod model_profile_kernel_16384 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_16384(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [1024] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_context_fp16_storage_16384(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 16384] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [1024] }>,
...
#[cutile::module]
pub mod model_profile_preprojected_kernel_16384 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_project_query_once_16384(
        out: &mut Tensor<f32, { [1, 32] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_projection: &Tensor<f32, { [-1, 64] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_preprojected_16384(
        out: &mut Tensor<f32, { [1, 16] }>,
        projected_query: &Tensor<f32, { [-1, 32] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [1024] }>,
...
#[cutile::module]
pub mod full_kv_baseline_kernel_32768 {
    use cutile::core::*;

    fn physical_block(table: &Tensor<i32, { [2048] }>, logical: i32) -> i32 {
        let table_tile: Tile<i32, { [2048] }> = table.load_tile(const_shape![2048], [0]);
        let selected: Tile<i32, { [1] }> = extract(table_tile, [scalar_to_tile(logical)]);
        tile_to_scalar(selected.reshape(const_shape![]))
    }
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_scores_fp16_storage_32768(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [2048] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_context_fp16_storage_32768(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 32768] }>,
        v_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [2048] }>,
...
#[cutile::module]
pub mod model_profile_kernel_32768 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_32768(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [2048] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_context_fp16_storage_32768(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 32768] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [2048] }>,
...
#[cutile::module]
pub mod model_profile_preprojected_kernel_32768 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_project_query_once_32768(
        out: &mut Tensor<f32, { [1, 32] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_projection: &Tensor<f32, { [-1, 64] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_preprojected_32768(
        out: &mut Tensor<f32, { [1, 16] }>,
        projected_query: &Tensor<f32, { [-1, 32] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [2048] }>,
...
#[cutile::module]
pub mod full_kv_baseline_kernel_49152 {
    use cutile::core::*;

    fn physical_block(table: &Tensor<i32, { [3072] }>, logical: i32) -> i32 {
        let table_tile: Tile<i32, { [3072] }> = table.load_tile(const_shape![3072], [0]);
        let selected: Tile<i32, { [1] }> = extract(table_tile, [scalar_to_tile(logical)]);
        tile_to_scalar(selected.reshape(const_shape![]))
    }
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_scores_fp16_storage_49152(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [3072] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_context_fp16_storage_49152(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 49152] }>,
        v_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [3072] }>,
...
#[cutile::module]
pub mod model_profile_kernel_49152 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_49152(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [3072] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_context_fp16_storage_49152(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 49152] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [3072] }>,
...
#[cutile::module]
pub mod model_profile_preprojected_kernel_49152 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_project_query_once_49152(
        out: &mut Tensor<f32, { [1, 32] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_projection: &Tensor<f32, { [-1, 64] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_preprojected_49152(
        out: &mut Tensor<f32, { [1, 16] }>,
        projected_query: &Tensor<f32, { [-1, 32] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [3072] }>,
...
#[cutile::module]
pub mod full_kv_baseline_kernel_65536 {
    use cutile::core::*;

    fn physical_block(table: &Tensor<i32, { [4096] }>, logical: i32) -> i32 {
        let table_tile: Tile<i32, { [4096] }> = table.load_tile(const_shape![4096], [0]);
        let selected: Tile<i32, { [1] }> = extract(table_tile, [scalar_to_tile(logical)]);
        tile_to_scalar(selected.reshape(const_shape![]))
    }
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_scores_fp16_storage_65536(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [4096] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_context_fp16_storage_65536(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 65536] }>,
        v_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [4096] }>,
...
#[cutile::module]
pub mod model_profile_kernel_65536 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_65536(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [4096] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_context_fp16_storage_65536(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 65536] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [4096] }>,
...
#[cutile::module]
pub mod model_profile_preprojected_kernel_65536 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_project_query_once_65536(
        out: &mut Tensor<f32, { [1, 32] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_projection: &Tensor<f32, { [-1, 64] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_preprojected_65536(
        out: &mut Tensor<f32, { [1, 16] }>,
        projected_query: &Tensor<f32, { [-1, 32] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [4096] }>,
...
#[cutile::module]
pub mod full_kv_baseline_kernel_98304 {
    use cutile::core::*;

    fn physical_block(table: &Tensor<i32, { [6144] }>, logical: i32) -> i32 {
        let table_tile: Tile<i32, { [6144] }> = table.load_tile(const_shape![6144], [0]);
        let selected: Tile<i32, { [1] }> = extract(table_tile, [scalar_to_tile(logical)]);
        tile_to_scalar(selected.reshape(const_shape![]))
    }
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_scores_fp16_storage_98304(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [6144] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_context_fp16_storage_98304(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 98304] }>,
        v_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [6144] }>,
...
#[cutile::module]
pub mod model_profile_kernel_98304 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_98304(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [6144] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_context_fp16_storage_98304(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 98304] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [6144] }>,
...
#[cutile::module]
pub mod model_profile_preprojected_kernel_98304 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_project_query_once_98304(
        out: &mut Tensor<f32, { [1, 32] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_projection: &Tensor<f32, { [-1, 64] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_preprojected_98304(
        out: &mut Tensor<f32, { [1, 16] }>,
        projected_query: &Tensor<f32, { [-1, 32] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [6144] }>,
...
#[cutile::module]
pub mod full_kv_baseline_kernel_131072 {
    use cutile::core::*;

    fn physical_block(table: &Tensor<i32, { [8192] }>, logical: i32) -> i32 {
        let table_tile: Tile<i32, { [8192] }> = table.load_tile(const_shape![8192], [0]);
        let selected: Tile<i32, { [1] }> = extract(table_tile, [scalar_to_tile(logical)]);
        tile_to_scalar(selected.reshape(const_shape![]))
    }
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_scores_fp16_storage_131072(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [8192] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_full_kv_context_fp16_storage_131072(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 131072] }>,
        v_fp16: &Tensor<f16, { [-1, 64] }>,
        table: &Tensor<i32, { [8192] }>,
...
#[cutile::module]
pub mod model_profile_kernel_131072 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_131072(
        out: &mut Tensor<f32, { [1, 16] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [8192] }>,
    ...
    #[cutile::entry()]
    pub fn model_small_context_fp16_storage_131072(
        out: &mut Tensor<f32, { [1, 64] }>,
        probabilities: &Tensor<f32, { [-1, 131072] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [8192] }>,
...
#[cutile::module]
pub mod model_profile_preprojected_kernel_131072 {
    use cutile::core::*;
    ...
    #[cutile::entry()]
    pub fn model_small_project_query_once_131072(
        out: &mut Tensor<f32, { [1, 32] }>,
        q: &Tensor<f32, { [-1, 64] }>,
        k_projection: &Tensor<f32, { [-1, 64] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn model_small_scores_fp16_storage_preprojected_131072(
        out: &mut Tensor<f32, { [1, 16] }>,
        projected_query: &Tensor<f32, { [-1, 32] }>,
        latent_fp16: &Tensor<f16, { [-1, 32] }>,
        table: &Tensor<i32, { [8192] }>,
