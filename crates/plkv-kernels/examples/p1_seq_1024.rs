...
mod gpu_impl {
    ...
    use plkv_kernels::cutile::p1_sequence_kernels::model_profile_preprojected_kernel_1024;
    use serde::Serialize;
    ...
    fn enqueue_latent_preprojected(
        ...
        let (projected_part, _, _) = unsafe {
            model_profile_preprojected_kernel_1024::model_small_project_query_once_1024(
        ...
        let (scores_part, _, _, _, _) = unsafe {
            model_profile_preprojected_kernel_1024::model_small_scores_fp16_storage_preprojected_1024(
                scores_out.partition([1, BLOCK_SIZE]),
                &projected_query,
                &inputs.latent,
                &inputs.table,
