...
mod gpu_impl {
    ...
    use plkv_kernels::cutile::p1_sequence_kernels::model_profile_preprojected_kernel_16384;
    use serde::Serialize;
    ...
    const ACTIVE_SEQ_LEN: usize = 16384;
    const NUM_PHYSICAL_BLOCKS: usize = 1024;
    ...
    fn enqueue_latent_preprojected(
        ...
        let (projected_part, _, _) = unsafe {
            model_profile_preprojected_kernel_16384::model_small_project_query_once_16384(
        ...
        let (scores_part, _, _, _, _) = unsafe {
            model_profile_preprojected_kernel_16384::model_small_scores_fp16_storage_preprojected_16384(
                scores_out.partition([1, BLOCK_SIZE]),
                &projected_query,
                &inputs.latent,
                &inputs.table,
